...
def get_multimodal_train_transform(image_size: int = 224):
...
def get_multimodal_eval_transform(image_size: int = 224):
    return transforms.Compose(
        [
...
class MultimodalDataset(Dataset):
    ...
    def _load_image(self, sample_id: str) -> Image.Image:
        ...
        try:
            ...
            return Image.new(
                "RGB",
                (self.fallback_image_size, self.fallback_image_size),
                color=(0, 0, 0),
            )
